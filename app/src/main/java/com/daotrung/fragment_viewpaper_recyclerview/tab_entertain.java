...
public class tab_entertain extends Fragment {
    ...
    private void addData() {
        arrayList.add(new NewsMode(R.drawable.img_gt_2,"Giai tri 1"));
        arrayList.add(new NewsMode(R.drawable.img_gt_4,"Giai tri 2"));
        arrayList.add(new NewsMode(R.drawable.img_gt_2,"Giai tri 1"));
        arrayList.add(new NewsMode(R.drawable.img_gt_4,"Giai tri 2"));
        arrayList.add(new NewsMode(R.drawable.img_gt_2,"Giai tri 1"));
        arrayList.add(new NewsMode(R.drawable.img_gt_4,"Giai tri 2"));
